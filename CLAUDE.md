...
This repository is indexed with Graphify. Before writing code, planning architecture, or doing wide directory searches, you MUST first read `.graphify_ast.json` and `.graphify_detect.json` to understand the codebase structure and dependencies. This is mandatory to conserve tokens. Do not perform manual file discovery if the answer is in the graph.
